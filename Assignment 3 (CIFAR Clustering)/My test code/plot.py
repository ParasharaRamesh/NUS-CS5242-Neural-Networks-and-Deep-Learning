...
def plot_ucc_model_stats(
        ...
        ucc_training_accuracy, ae_training_accuracy,
        ucc_validation_losses, ae_validation_losses, combined_validation_losses,
        ucc_validation_accuracy, ae_validation_accuracy
    ):
    ...
    axes[0, 1].plot(epochs, ae_training_accuracy, marker="o", color="blue", label="AE Training Accuracy")
    ...
    axes[1, 1].plot(epochs, ae_validation_accuracy, marker="o", color="blue", label="AE Validation Accuracy")
...
def plot_ucc_rcc_model_stats(
        ...
        ucc_training_accuracy, ae_training_accuracy, rcc_training_accuracy,
        ucc_validation_losses, ae_validation_losses, rcc_validation_losses, ucc_rcc_validation_losses, combined_validation_losses,
        ucc_validation_accuracy, ae_validation_accuracy, rcc_validation_accuracy
    ):
